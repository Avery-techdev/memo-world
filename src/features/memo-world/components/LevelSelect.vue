...
<template>
  <section class="mx-auto flex max-w-3xl flex-col items-center gap-8 text-center">
    <div class="flex flex-col gap-2">
      ...
      >
        MEMO<span class="animate-title-dot motion-reduce:animate-none inline-block text-accent"
          >·</span
        >WORLD
      </h1>
    ...
    <div class="mt-2 flex flex-col items-center gap-2 text-center text-xs text-ui-muted">
      <p>
        by
        <a
          ...
          class="font-semibold text-ui-text underline decoration-card-back-line underline-offset-2 transition-colors hover:text-accent"
        >
          Avery Hauschild
        </a>
      </p>
      <a
        href="https://github.com/Avery-techdev/memo-world"
        target="_blank"
        rel="noopener noreferrer"
